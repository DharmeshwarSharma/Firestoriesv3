...
export function ContentCard({ item }: ContentCardProps) {
  ...
  return (
    <>
      <div
        className="flex-shrink-0 w-100 group cursor-pointer transition-all duration-700 hover:translate-y-2 focus:outline-none focus:ring-2 focus:ring-[#ff6404] rounded-lg mr-6 transform-gpu hover:z-10 relative"
